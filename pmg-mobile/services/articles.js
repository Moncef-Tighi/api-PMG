...
var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault"),
    ...
    getDepotStockFor = function (a) {
        ...
        }).joinRaw("LEFT OUTER JOIN ARTICLE ON GQ_ARTICLE=GA_ARTICLE").joinRaw("LEFT OUTER JOIN DEPOTS ON GDE_DEPOT=GQ_DEPOT").joinRaw("LEFT OUTER JOIN DIMENSION GDI1 ON GDI1.GDI_TYPEDIM='DI1' AND GDI1.GDI_GRILLEDIM=GA_GRILLEDIM1 AND GDI1.GDI_CODEDIM=GA_CODEDIM1").joinRaw("LEFT OUTER JOIN DIMENSION GDI2 ON GDI2.GDI_TYPEDIM='DI2' AND GDI2.GDI_GRILLEDIM=GA_GRILLEDIM2 AND GDI2.GDI_CODEDIM=GA_CODEDIM2").where("GQ_CLOTURE", "-").whereIn("GA_STATUTART", ["DIM", "UNI"]).where("GA_CODEARTICLE", a)
    },
