...
LEFT JOIN DIMENSION ON DIMENSION.GDI_CODEDIM = GA_CODEDIM1

WHERE GA_CODEARTICLE='GM500SSB'
GROUP BY
GA_CODEARTICLE,
GA_CODEBARRE,
GDI_LIBELLE

--Stock global sans compter la taille
...
FROM DISPO
LEFT JOIN ARTICLE ON GA_ARTICLE = GQ_ARTICLE
WHERE GA_CODEARTICLE='511881-604'
