...
SELECT TOP 1000
GA_CODEARTICLE, GA_FAMILLENIV1,GA_FAMILLENIV2, GA_DATECREATION, GA_DATEMODIF, GA_LIBELLE, GA_PVTTC AS 'prixInitial' 
...
GROUP BY Ga_CODEARTICLE, GA_DATECREATION,GA_FAMILLENIV1,GA_FAMILLENIV2,GA_LIBELLE,GA_PVTTC
,GDI1.GDI_LIBELLE , GDI2.GDI_LIBELLE,GA_DATEMODIF

--ORDER BY SUM(GQ_PHYSIQUE-GQ_RESERVECLI+GQ_RESERVEFOU-GQ_PREPACLI) DESC
